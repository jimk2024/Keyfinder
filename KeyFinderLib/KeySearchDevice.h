...
typedef struct {
    ...
    unsigned int hash[5];
    bool compressed;
    bool toggled; // whether the compressed prefix was flipped (02<->03) to hit
}KeySearchResult;
...
public:
    ...
    // Enable/disable randomized initial key ordering. Default no-op for devices that don't support it.
    virtual void setRandom(bool /*randomMode*/) {}
};

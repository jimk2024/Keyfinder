...
namespace Hash {
	...
	// Compute RIPEMD160(SHA256( (02/03)^flipped || x )) given x and y words; prefix parity is inverted relative to y LSB
	void hashPublicKeyCompressedFlipped(const unsigned int *x, const unsigned int *y, unsigned int *digest);
